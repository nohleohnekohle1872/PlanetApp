...
namespace PlanetApp
{
    public class Point
    {
        ...
        {
            if (sign == "  ")
                HelpSystems.PrintString((int)X, (int)Y, sign, color, color);
            else
                HelpSystems.PrintString((int)X, (int)Y, sign, color);
        }

        public void Remove()
        {
            HelpSystems.PrintString((int)X, (int)Y, "  ", ConsoleColor.Black);
        }
